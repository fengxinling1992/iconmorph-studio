...
export function renderVariantSvg(asset: IconAsset, style: StyleId, params: RenderParams, size = 320) {
  ...
  const glassOutline = `<svg x="52" y="52" width="216" height="216" viewBox="${viewBox}" preserveAspectRatio="xMidYMid meet"><style>.${glassOutlineClass} *{fill:none!important;stroke:#FFFFFF!important;stroke-width:1.45!important;stroke-linejoin:round!important}.${glassOutlineClass} [fill="#fff"],.${glassOutlineClass} [fill="#ffffff"],.${glassOutlineClass} [fill="#FFFFFF"],.${glassOutlineClass} [fill="white"],.${glassOutlineClass} [fill="#F7F4EE"]{fill:#FFFFFF!important;stroke:none!important}</style><g class="${glassOutlineClass}" opacity="${(params.glassHighlight / 150).toFixed(2)}">${content}</g></svg>`;
  ...
  const projectedSceneHighlight = `<g transform="${sceneIsoTransform}"><svg x="${sceneOrigin.x}" y="${sceneOrigin.y}" width="${sceneOrigin.width}" height="${sceneOrigin.width}" viewBox="${viewBox}" preserveAspectRatio="xMidYMid meet"><style>.${sceneHighlightClass} *{fill:none!important;stroke:#FFFFFF!important;stroke-width:2.1!important}.${sceneHighlightClass} [fill="#fff"],.${sceneHighlightClass} [fill="#ffffff"],.${sceneHighlightClass} [fill="#FFFFFF"],.${sceneHighlightClass} [fill="white"],.${sceneHighlightClass} [fill="#F7F4EE"]{fill:#FFFFFF!important;stroke:none!important}</style><g class="${sceneHighlightClass}" opacity="${(params.sceneHighlight / 175).toFixed(2)}">${content}</g></svg></g>`;
